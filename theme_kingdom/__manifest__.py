...
Sales → Pricelists for offer pricing. eCommerce → Promotions for cart discounts.
    ...
    'data': [
        ...
        'data/remove_dynamic_product_tabs.xml',
        ...
        'data/fix_legacy_brands_snippet.xml',
    ...
    'assets': {
        ...
        'web.assets_frontend': [
            ...
            # Odoo already ships Bootstrap — skip duplicate bootstrap.min.css (~227KB).
        ...
        'web.assets_backend': [
            (
                'after',
                'website/static/src/client_actions/website_preview/website_switcher_systray_item.js',
                'theme_kingdom/static/src/js/kingdom_website_switcher_patch.js',
            ),
        ],
